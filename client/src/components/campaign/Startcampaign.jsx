...
const StartCampaign = () => {
  ...
  const validateStep1 = () => {
    ...
    // **MODIFIED:** PAN is now optional, but if entered, it must be valid.
    if (formData.creator_pan.trim() && !panRegex.test(formData.creator_pan.toUpperCase())) {
      newErrors.creator_pan = "Invalid PAN number format.";
    }
