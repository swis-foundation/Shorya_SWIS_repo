    ...
    <div className="bg-brand-background pt-24 pb-12 px-4 sm:px-6 lg:px-8">
      ...
      <div className="mt-16 max-w-5xl mx-auto grid md:grid-cols-3 gap-10 text-center">
        <div className="bg-white p-8 rounded-xl shadow-lg">
          <FaSearch className="text-5xl text-brand-primary mx-auto mb-4" />
          <h3 className="text-xl font-bold text-brand-text mb-2">1. Discover a Cause</h3>
        ...
        <div className="bg-white p-8 rounded-xl shadow-lg">
          ...
          <h3 className="text-xl font-bold text-brand-text mb-2">2. Make a Donation</h3>
          <p className="text-brand-text-light">
        ...
        <div className="bg-white p-8 rounded-xl shadow-lg">
          ...
          <h3 className="text-xl font-bold text-brand-text mb-2">3. See Your Impact</h3>
          <p className="text-brand-text-light">
